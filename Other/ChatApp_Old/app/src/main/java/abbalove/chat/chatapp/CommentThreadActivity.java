...
import abbalove.chat.chatapp.adapters.CommentAdapter;
import abbalove.chat.chatapp.models.Comment;
import abbalove.chat.chatapp.models.User;
import abbalove.chat.chatapp.models.WorldPost;
...
//        movieList.add(movie);
        ...
        if (savedInstanceState == null) {
            ...
            if(extras == null) {
                ...
                firebaseDatabase = FirebaseDatabase.getInstance();
                databaseReference = firebaseDatabase.getReference("comment_thread").child(key);
...
//                post.content = content.toString();
                ...
                btnSend.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        userData  = PrefUtils.getCurrentUser(CommentThreadActivity.this);
                        final WorldPost post = new WorldPost();
