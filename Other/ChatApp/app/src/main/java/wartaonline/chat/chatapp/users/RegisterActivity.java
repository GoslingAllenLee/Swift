package wartaonline.chat.chatapp.users;
...
public class RegisterActivity extends AppCompatActivity {
                        ...
                        .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    addUserToDatabase(RegisterActivity.this, fUser);
                                    startActivity(new Intent(RegisterActivity.this, LoginActivity.class));
                                    finish();
                                }
                            }
    ...
    public void addUserToDatabase(final Context context, FirebaseUser firebaseUser) {
        final User user = new User(firebaseUser.getUid(), inputname.getText().toString(),
